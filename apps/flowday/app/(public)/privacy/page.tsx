    ...
    <main className="mx-auto max-w-2xl space-y-4 px-6 py-10 text-sm leading-relaxed">
      ...
      {en ? (
        <>
          ...
          <p><strong>AI use:</strong> evidence photos are sent to AI providers (Gemini/Claude) solely to verify them, via short-lived signed URLs. Groq and Cerebras (used for text features) never train on your data. Claude, under its commercial terms, does not train on your data either. Gemini&apos;s free tier — our default for photo verification, to keep the service free — may use submitted content to improve Google&apos;s products. Because of this, we ask you to avoid showing your face, other people, ID documents, or sensitive screens in your evidence photo: focus only on the task itself.</p>
        ...
        <>
          ...
          <p><strong>Uso de IA:</strong> las fotos de evidencia se envían a proveedores de IA (Gemini/Claude) solo para verificarlas, vía URLs firmadas efímeras. Groq y Cerebras (usados en funciones de texto) nunca entrenan con tus datos. Claude, bajo sus términos comerciales, tampoco entrena con tus datos. El tier gratuito de Gemini —el que usamos por defecto para verificar fotos, para mantener el servicio gratis— sí puede usar el contenido enviado para mejorar sus productos. Por eso te pedimos evitar mostrar tu rostro, a otras personas, documentos de identidad o pantallas sensibles en la foto de evidencia: enfoca solo la tarea.</p>
