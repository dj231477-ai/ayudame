    ...
    <main className="mx-auto max-w-2xl space-y-4 px-6 py-10 text-sm leading-relaxed">
      ...
      {en ? (
        <>
          ...
          <p><strong>AI use:</strong> evidence photos are sent to AI providers (Gemini/Claude) solely to verify them, via short-lived signed URLs, and are not used to train models.</p>
        ...
        <>
          ...
          <p><strong>Uso de IA:</strong> las fotos de evidencia se envían a proveedores de IA (Gemini/Claude) solo para verificarlas, vía URLs firmadas efímeras, y no se usan para entrenar modelos.</p>
